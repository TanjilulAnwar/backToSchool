...
namespace ConsoleApp1
{
	class Program
	{
		...
		static void Main(string[] args)
		{
			...
			filter.Add("TIMO");
			filter.Add("nemo");
			Console.WriteLine(filter.Contains("MARE"));
			Console.WriteLine(filter.Contains("AREM"));
			Console.WriteLine(filter.Contains("mare"));
			Console.WriteLine(filter.Contains("ARME"));
			Console.WriteLine(filter.Contains("MMMM"));
			Console.WriteLine(filter.Contains("M"));
			Console.WriteLine(filter.Contains("TIMo"));
